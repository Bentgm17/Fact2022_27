...
class infMaxConfig(object):
	def __init__(self, args):
		...
		if self.timing_test:
			...
			self.weight = 0.01
			self.filename = 'data/twitter/sample_4000'
		...
		# 	self.filename = 'sample/sample_1000'
			...
			self.filename = 'data/synth2/synthetic_n' + str(args.nodes) + '_Pred' + str(args.Pred) + \
		...
		# 	self.filename = 'synthetic_3layers/synthetic_3layers_n500_Pred0.7_Phom0.025_Phet0.003'
			...
			self.weight = args.Pact
			self.filename = 'data/synth3/synthetic_3g_n' + str(args.nodes) + '_Pred' + str(args.Pred) + \
							'_Pblue' + str(args.Pblue) + '_Prr' + str(args.Prr) + '_Pbb' + str(args.Pbb) + \
							'_Pgg' + str(args.Pgg) + '_Prb' + str(args.Prb) + '_Prg' + str(args.Prg) + \
							'_Pbg' + str(args.Pbg)

		elif self.synthetic_extention:
			self.weight = 0.03
			self.filename = 'data/synth5/synth200_Phom0.01-0.05_Phet0.001-0.005'
